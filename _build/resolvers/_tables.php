...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('remove_duplicates_modx', MODX_CORE_PATH . 'components/remove_duplicates_modx/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/remove_duplicates_modx/model/schema/remove_duplicates_modx.mysql.schema.xml';
